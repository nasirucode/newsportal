  <style type="text/css">.cat{text-transform: uppercase; color: darkblue; font-weight: bold;}
  .card-header{font-weight: bold;}</style>
  <div class="col-md-4">
...
?>
                    ...
                    <li>
                      <a href="category.php?catid=<?php echo htmlentities($row['id'])?>" class="cat"><?php echo htmlentities($row['CategoryName']);?></a>
                    </li>
<?php } ?>
                  </ul>
                </div>
...
?>
  ...
  <li>
                      <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>"><?php echo htmlentities($row['posttitle']);?><br> <font color="black"><?php echo htmlentities($row['postingdate']);?></font></a>
                    </li>
            <?php } ?>
          </ul>
            </div>
...
?>
  ...
  <li>
            ...
            <?php } ?>-->
            <li><marquee direction="up">Beware of 419 Beware of 419 Beware of 419 Beware of 419 Beware of 419
                Beware of 419 Beware of 419 Beware of 419 Beware of 419 Beware of 419
                Beware of 419 Beware of 419 Beware of 419 Beware of 419 Beware of 419
                Beware of 419 Beware of 419Beware of 419</marquee></li>
          </ul>
            </div>
          </div>
